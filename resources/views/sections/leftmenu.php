    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
       ...
       <li id="booking"><a href="<?php echo url('/booking');?>"><i class="fa fa-plus"></i>Booking</a></li>
        ...
        <li id="clock"><a href="<?php echo url('/clock');?>"><i class="fa fa-plus"></i>Employee Clock In/Out </a></li>
        ...
        <li id="empreport"><a href="<?php echo url('/employee/report');?>"><i class="fa fa-plus"></i>Employee Report</a></li>
