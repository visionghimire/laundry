                ...
                <form class="form-horizontal" id="form"  method="post">
                    ...
                    <div class="box col-md-4">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="name" class="col-sm-3 control-label">Price Per Unit</label>
 ...
 $("#inventory").addClass('active');
    ...
    function table() {
        ...
        $.ajax({
            ...
            method: 'get',
            url: baseurl + "/inventory/list?entry=" + entry + "&page=" + page + "&search=" + search,
    ...
    function searchClicked(e) {
        ...
        $.ajax({
            ...
            method: 'get',
            url: baseurl + "/inventory/list?entry=" + entry + "&search=" + search,
            success: function (response) {
                createTable(response);
            },
            fail: function () {
    ...
    function formSubmit(e) {
        ...
        if ($('#id').val() == "") {
            ...
            var url = baseurl + "/inventory/creates";
        } else {
            var url = baseurl + "/inventory/updates/" + id;
        }
        $.ajax({
            method: "POST",
            url: url,
    ...
    function delt(id) {
        ...
        if (conf) {
            $.ajax({
                method: 'get',
                url: baseurl + "/inventory/deletes/" + id,
                success: function (resp) {
                    var a = JSON.parse(resp);
                    toast(a);
                    table();
